...
/**
 * Descrição de ControleNiveisAcesso
 *
...
class ControleNiveisAcesso {
    ...
    public function cadastrar() {
        ...
        $CarregarView = new ConfigView('niveisacesso/cadastrarNivelAcesso');
        $CarregarView->renderizar();
    }
    ...
    private function alterarPrivado() {
        if (!empty($this->Dados['SendEditNivelAcesso'])):
            ...
            if (!$EditaNivelAcesso->getResultado()):
                $_SESSION['msg'] = "<div class='alert alert-danger'>Para editar o nivel de acesso preencha todos os campos!</div>";
            else:
